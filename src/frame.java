...
public class frame extends JFrame implements MouseMotionListener, MouseListener, ActionListener {
    ...
    char[] arr = new char[9];
    ImageIcon cross = new ImageIcon(new ImageIcon(getClass().getClassLoader().getResource("img/cross.png")).getImage().getScaledInstance(100, 100, Image.SCALE_DEFAULT));
    ImageIcon round = new ImageIcon(new ImageIcon(getClass().getClassLoader().getResource("img/round.png")).getImage().getScaledInstance(100, 100, Image.SCALE_DEFAULT));
